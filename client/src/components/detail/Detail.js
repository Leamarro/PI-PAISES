          ...
          <div className="country">
            ...
            <div className="midCard">
              <div className="infoDiv">
                ...
                {country.continent ? (
                  <div className="iconedDiv">
                    <img src={Location} alt="location" height="15" width="15" />
                    <h4>
                      {country.continent}{" "}
                ...
                <div className="iconedDiv">
                  <img src={Language} alt="lenguage" height="15" width="15" />
              ...
              <div className="infoDiv">
                ...
                <div>
                  <div className="iconedDiv">
                    <img src={Population} alt="population" height="15" width="15" />
                    <h4>Population: {formatPopulation(country.population)}</h4>
                  </div>
                </div>
                <div className="iconedDiv">
                  <img src={Area} alt="area" height="15" width="15" />
                  <h4>Area: {formatArea(country.area)}</h4>
                </div>
              </div>
              <img src={country.flag} alt="flag" className="detailedFlag" />
            </div>
          </div>
