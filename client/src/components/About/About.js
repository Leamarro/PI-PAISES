    ...
    <AboutDiv>
      ...
      <div className="pern">
        <a href="https://www.postgresql.org/" >
          <img src={Postgres} alt="img" width="50" heigth="50" className="pernIcon" />
        </a>
        <a href="https://expressjs.com/">
          <img src={Express} alt="img2" width="150"  height="50" className="pernIcon" />
        </a>
        <a href="https://redux.js.org/">
          <img src={Redux} alt="img3" width="60" height="50" className="pernIcon" />
        </a>
        <a href="https://reactjs.org/">
          <img src={ReactLogo} alt="img4" width="60" height="50" className="pernIcon" />
        </a>
